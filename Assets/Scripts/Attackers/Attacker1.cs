...
public class Attacker1 : Attacker
{
    ...
    private float totalDuration1 = 1.33f;
    private float totalDuration2 = 1.33f;
    private float totalDuration3 = 1f;
    private float totalDuration4 = 1.2f;
    private float totalDuration5 = 1f;
    private float totalDuration6 = 1.66f;
    private float totalDuration7 = 2.66f;
    int DropReward = 2;
