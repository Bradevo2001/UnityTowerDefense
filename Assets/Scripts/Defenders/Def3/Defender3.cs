...
public class Defender3 : Defender
{
    ...
    IEnumerator Shoot()
    {
        while(true)
        {
            ...
            if(nearestAttacker != null)
            {
                ...
                extraAngleQ = Quaternion.Euler(0f, 0f, ShotgunAngle);
                Quaternion angle1 = TurnAngle * extraAngleQ;
                bullet = Instantiate(Bullet, transform.position, angle1);

                extraAngleQ = Quaternion.Euler(0f, 0f, -ShotgunAngle);
                Quaternion angle2 = TurnAngle * extraAngleQ;
                bullet = Instantiate(Bullet, transform.position, angle2);
