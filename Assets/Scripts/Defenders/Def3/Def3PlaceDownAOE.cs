...
public class Def3PlaceDownAOE : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Parent = transform.parent.GetComponent<Defender3>();
    }
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            RaycastHit2D hit = Physics2D.Raycast(mousePosition, Vector2.zero);
                ...
                if(hit.collider != null && hit.transform.gameObject.name == "Defender3(Clone)")
                {
