...
public class Defender2 : Defender
{
        ...
        while(true)
        {
            if (TargetMode == true)
            {
                if(nearestAttacker != null)
                {
                    ...
                    GameObject bullet = Instantiate(BigBullet, transform.position, TurnAngle);
