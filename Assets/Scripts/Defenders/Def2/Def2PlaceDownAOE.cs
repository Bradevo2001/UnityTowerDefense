...
public class Def2PlaceDownAOE : MonoBehaviour
{
    public Economy Eco;
    ...
    void Start()
    {
        ...
        Parent = transform.parent.GetComponent<Defender2>();
    }
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            RaycastHit2D hit = Physics2D.Raycast(mousePosition, Vector2.zero);
                ...
                if(hit.collider != null && hit.transform.gameObject.name == "Defender2(Clone)")
                {
